 class tabBoundary{
  ...
  public float mass,vx,vy,ax,ay,density,friction_u,momentum,bax ,bay,pathWidth=20,
               gconst = 0.1,floor = 590,rtheta = 0,avoidance,cohesion;
  ...
  void create_points(ArrayList<tabBoundary> a){
    for(int i=0;i<a.size();i++){
  ...
  void create_angles(ArrayList<tabBoundary> a){
    for(int i=0;i<a.size();i++){
  ...
  void update_points(ArrayList<tabBoundary> a){
  ...
  void update_Boundaries(tabBoundary a){
  ...
  void create_rotation_points(ArrayList<tabBoundary>a){
  ...
  void pos_rotationpoint(tabBoundary a){
  ...
  void mtranslate(tabBoundary b ,PVector m){
  ...
  void update_dist(ArrayList<tabBoundary> a){
  ...
  void move(tabBoundary a,PVector p){
    float mx = p.x;
    float my = p.y;
